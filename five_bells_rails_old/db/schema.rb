...
ActiveRecord::Schema.define(version: 2019_11_18_083901) do
  ...
  create_table "governments", force: :cascade do |t|
    ...
    t.index ["region_id"], name: "index_governments_on_region_id"
  end
  ...
  create_table "markets", force: :cascade do |t|
    ...
    t.index ["region_id"], name: "index_markets_on_region_id"
  ...
  create_table "time_series", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["provider_type", "provider_id"], name: "index_time_series_on_provider_type_and_provider_id"
  end
  ...
  add_foreign_key "factories", "regions"
  ...
  add_foreign_key "governments", "regions"
  ...
  add_foreign_key "markets", "regions"
